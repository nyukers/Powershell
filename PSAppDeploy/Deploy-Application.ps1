...
Try {
	...
	[string]$appVendor = 'Noname Inc.'
	[string]$appName = 'ADRestore'
	[string]$appVersion = '11.0.6'
	[string]$appArch = ''
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '3.6.5'
	[string]$appScriptDate = '01/07/2021'
	[string]$appScriptAuthor = 'Nyukers'
	##*===============================================
	...
	If ($deploymentType -ine 'Uninstall') {
	    ...
	    Show-InstallationWelcome -CloseApps 'ADRestore.NET' -AllowDefer -DeferTimes 3
	    # Show Progress Message (with the default message)
	    Show-InstallationProgress
	    # Remove any previous versions of Adobe Reader
	    Remove-MSIApplications -Name 'ADRestore.NET'
	    ...
	    Execute-MSI -Action Install -Path 'ADRestore.msi' 
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
	    ...
	    Execute-MSI -Action Uninstall -Path '{2FF988D8-F631-4ED3-BCB0-7ABC79D9A10E}'
